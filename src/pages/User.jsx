  ...
  return (
    <>
      <div className='w-full mx-auto lg:w-10/12'>
        ...
        <div className='grid grid-cols-1 xl:grid-cols-3 lg:grid-cols-3 md:grid-cols-3 mb-8 md:gap-8 text-white'>
          <div className='custom-card-image mb-1 md:mb-0'>
            <div className='relative rounded-lg shadow-xl card'>
              <figure>
                <img src={avatar_url} alt='Profile' className='rounded-lg brightness-50' />
              </figure>
